...
<table border ="1" width="90%">
	<tr>
		<td width="10%">번호</td>
		<td width="35%">${board.num }</td>
		<td width="20%">작성자</td>
		<td width="25%">${board.id }</td>
	</tr>
	<tr>
		<td width="10%">작성일</td>
		<td width="35%"> ${board.postdate }</td>
		<td width="20%">조회수</td>
		<td width="25%"> ${board.visitcount }</td>
	</tr>
	
	<tr>
		<td width="10%">제목</td>
		<td width="80%" colspan="3"> ${board.title }</td>
	</tr>
	
	<tr height="200px">
		<td width="10%">내용</td>
		<td width="80%" colspan="3"> ${board.content }</td>
	</tr>
	<tr>
